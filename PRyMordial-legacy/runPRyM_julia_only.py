# -*- coding: utf-8 -*-
# Run PRyMordial with Julia solvers (numba disabled to avoid LLVM conflict)
import time
import numpy as np
from scipy.integrate import quad
from scipy.special import kv

# Initialize Julia before any PRyM imports to avoid LLVM conflicts
from julia.api import Julia
jl = Julia(runtime='/usr/local/bin/julia', compiled_modules=False)
...
PRyMini.numba_flag = False  # Disable numba to avoid LLVM conflict with Julia
